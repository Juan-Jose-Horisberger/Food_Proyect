...
import imageFondo from "../../Imagenes/backgroundImage.jpg";
...
export default function CreateRecipe() {
   ...
   return (
      ...
      >
         ...
         <div
            className={`container col-10 my-5 py-3 py-md-5 ${styles.containerForm}`}
         >
                  ...
                  <div className={`container-fluid`}>
                     ...
                     >
                        <div className="col-12 col-md-3 d-flex flex-column justify-content-start mb-2">
                           <p
                              className={`d-flex col-12 col-md-12 fs-5 ${styles.typography} ${styles.display}`}
                           >
                              Create new step
                           </p>
